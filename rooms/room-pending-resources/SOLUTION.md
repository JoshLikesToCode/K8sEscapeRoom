...
kubectl get pod escape-app -n escape-room-pending-resources \
...
kubectl delete pod escape-app -n escape-room-pending-resources

# Create a new pod with reasonable resource requests
kubectl run escape-app -n escape-room-pending-resources \
  --image=nginx:1.25 \
  --port=80 \
...
kubectl describe pod escape-app -n escape-room-pending-resources | grep -A 3 "Events:"
