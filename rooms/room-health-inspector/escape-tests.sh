#!/usr/bin/env bash
# escape-tests.sh - Validate that room-health-inspector has been ESCAPED (fixed)
#
# Success criteria:
...
NAMESPACE="escape-room-health-inspector"
DEPLOYMENT_NAME="escape-app"
POD_LABEL="app=escape-app"

echo "=== Testing room-health-inspector (escaped/fixed state) ==="
echo ""
