#!/usr/bin/env bash
# escape-tests.sh - Validate boss-security-lockdown has been ESCAPED (fixed)
#
...
NAMESPACE="escape-boss-security-lockdown"
DEPLOYMENT_NAME="escape-app"
POD_LABEL="app=escape-app"

echo "=== Testing boss-security-lockdown (escaped/fixed state) ==="
echo ""
