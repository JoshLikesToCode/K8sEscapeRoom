...
kubectl get all -n escape-boss-security-lockdown
...
kubectl get events -n escape-boss-security-lockdown --sort-by='.lastTimestamp'
```
...
All resources are in the `escape-boss-security-lockdown` namespace.
