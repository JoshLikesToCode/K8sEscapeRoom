#!/usr/bin/env bash
# tests.sh - Validate boss-overzealous-warden is in expected failure state
#
...
# Configuration
NAMESPACE="${NAMESPACE:-escape-boss-overzealous-warden}"
DEPLOYMENT_NAME="escape-app"
POD_LABEL="app=escape-app"
ROOM_NAME="boss-overzealous-warden"
