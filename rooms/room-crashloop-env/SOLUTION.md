...
kubectl get deployment escape-app -n escape-room-crashloop-env -o yaml | grep -A 10 "env:"
...
```bash
kubectl edit deployment/escape-app -n escape-room-crashloop-env
```
...
kubectl rollout status deployment/escape-app -n escape-room-crashloop-env
